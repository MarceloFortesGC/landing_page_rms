      ...
      <div className="sm:text-center lg:text-left">
        ...
        <div className="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
          <div className="rounded-md shadow">
            <a
              onClick={() => window.open(mainHero.primaryAction.href, '_blank')}
              className={`w-full flex items-center text-white justify-center px-8 py-3 border border-transparent font-medium rounded-md bg-primary md:py-4 md:text-lg md:px-10 cursor-pointer`}
            >
